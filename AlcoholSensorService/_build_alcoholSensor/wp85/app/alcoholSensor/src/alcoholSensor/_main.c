...
// Startup code for the executable 'alcoholSensor'.
...
LE_SHARED le_log_SessionRef_t alcoholSensor_exe_LogSession;
LE_SHARED le_log_Level_t* alcoholSensor_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    alcoholSensor_exe_LogSession = log_RegComponent("alcoholSensor_exe", &alcoholSensor_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_AlcoholSensorComponent.so");
